...
VALUES (1, 'Tostada Tijuana', 'Black Beans, Lettuce and others', 4.25, 1, DATE '2015-04-1', DATE '2015-12-31', 8, 10, 12, 30, 3.5);
...
INSERT INTO menu(id, name, description, price, currency, from_valid_date, to_valid_date, from_hour, from_minute, to_hour, to_minute, ranking)
VALUES (3, 'Agnolottis', 'Original italian agnolottis with ham and cheese', 55.0, 2, DATE '2015-10-05', DATE '2016-04-10', 11, 0, 16, 0, 4.3);
...
INSERT INTO menu(id, name, description, price, currency, from_valid_date, to_valid_date, from_hour, from_minute, to_hour, to_minute, ranking)
VALUES (4, 'Risotto', 'An Italian rice with a creamy consistence', 42.0, 2, DATE '2014-07-01', DATE '2015-11-01', 11, 30, 16, 0, 3.8);
